...
**v0.1.0 development preview.** Intended target: Omarchy 4 / Hyprland. No live Omarchy acceptance or agent-directory approval is claimed. Individual apps must establish their own supported and actually tested versions. The badge is a community identity statement, not official certification.
