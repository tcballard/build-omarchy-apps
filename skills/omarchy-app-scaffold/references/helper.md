...
The architecture worksheet records responsibilities, dependencies and lifecycle decisions. Its prose is reviewed manually; `check` does not grade architecture or require existing projects to adopt this filename.
